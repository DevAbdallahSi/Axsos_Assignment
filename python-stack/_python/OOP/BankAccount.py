...
AccountB=BankAccount(2,5000)

AccountA.deposit(2000).deposit(1500).deposit(5000).withdraw(2000).yield_interest().display_account_info()
AccountB.deposit(1000).deposit(7000).withdraw(1000).withdraw(800).withdraw(2000).withdraw(1000).yield_interest().display_account_info()
