...
public class User {
	...
	public List<Talk> getOwnedTalks() {
		return ownedTalks;
	}
	public void setOwnedTalks(List<Talk> ownedTalks) {
		this.ownedTalks = ownedTalks;
	}
	public List<Talk> getJoinedTalks() {
		return joinedTalks;
	}
	public void setJoinedTalks(List<Talk> joinedTalks) {
		this.joinedTalks = joinedTalks;
	}
	public Long getId() {
  		return id;
  	}
